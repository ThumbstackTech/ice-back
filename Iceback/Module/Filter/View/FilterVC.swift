...
class FilterVC: UIViewController {
    ...
    func setUpController() {
        ...
        if isFromStores {
            if StoreType == "All" && !isStoreAllCategoryApply {
                CategoryAPICall()
            } else if StoreType == "New" && !isStoreNewCategoryApply {
                CategoryAPICall()
            } else if StoreType == "Trending" && !isStoreTrendingCategoryApply {
                CategoryAPICall()
            }
        } else {
            if DealsType == "New" && !isDealNewCategoryApply{
                CategoryAPICall()
            }  else  if DealsType == "Trending" && !isDealTrendingCategoryApply {
                CategoryAPICall()
            }
        }
...
extension FilterVC : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == self.tblFilterBy {
            ...
            // FilterByCell.lblCategoryCount.isHidden = true
            ...
            if isCategorySelected == true {
                ...
                FilterListCell.lblFilterName.text =  UserDefaultHelper.selectedLanguage == "de" ? arrRegionLists[indexPath.row].RegionNameData.de : arrRegionLists[indexPath.row].RegionNameData.en
